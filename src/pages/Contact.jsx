      ...
      <section className="fade-in-section opacity-0 translate-y-10 transition-all duration-700 ease-out py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            {/* Main Contact Card */}
            <div className="bg-gray-900 rounded-3xl shadow-2xl overflow-hidden border border-[#FFD700]/20 p-8 md:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Email */}
                <div className="flex items-start gap-4 p-6 rounded-2xl bg-black/50 border border-[#FFD700]/10 hover:border-[#FFD700]/30 transition-all group">
